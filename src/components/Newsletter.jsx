    ...
    <section className="py-16 md:py-24 bg-charcoal relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-2xl md:text-3xl lg:text-4xl font-medium text-white-pure mb-4 md:mb-6">
            Join the GlowLab Circle
          </h2>
          <p className="text-sm md:text-base text-white-pure/60 mb-8 leading-relaxed">
          ...
          >
            <input
              ...
              className="flex-1 bg-white-pure/10 border border-white-pure/20 text-white-pure placeholder:text-white-pure/40 px-5 py-3 md:py-3.5 text-sm focus:outline-none focus:border-gold transition-colors"
            />
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="bg-gold text-white-pure px-6 py-3 md:py-3.5 text-sm font-medium tracking-wide hover:bg-gold-dark transition-colors flex items-center justify-center gap-2"
            >
              Subscribe
              <ArrowRight size={16} />
            </motion.button>
